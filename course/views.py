...
def home(request):
    ...
    #either add Total Hrs in form or do automatic summation
    #Check Number of Pos and add remaining ones
    #design the fucking database if possible, feasible
    #Load data in form to edit the existing PDF
    ...
    if request.method == "POST":
        ...
        with doc.create(LongTable("|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|")) as data_table:
            ...
            data_table.add_hline()
            data_table.add_row((MultiColumn(3,align='|l|',color="black!30",data="Semester"),MultiColumn(4,align='l|',data=semester),
                                MultiColumn(2,align='l|',color="black!30",data="Version"),MultiColumn(3,align="l|",data=version),
                                MultiColumn(2,align='l|',color="black!30",data="Version1"),MultiColumn(2,align="l|",data=version1)))
            ...
            data_table.add_hline()
            data_table.add_row((MultiColumn(15,align='|r|',data="Total"),55))
            ...
            data_table.add_hline()
            data_table.add_row((bold("CO1"),C1P1,C1P2,C1P3,C1P4,C1P5,C1P6,C1P7,C1P8,C1P9,C1P10,C1P11,C1P12,0,0,0))

            data_table.add_hline()
            data_table.add_row((bold("CO2"),C2P1,C2P2,C2P3,C2P4,C2P5,C2P6,C2P7,C2P8,C2P9,C2P10,C2P11,C2P12,1,1,1))

            data_table.add_hline()
            data_table.add_row((bold("CO3"),C3P1,C3P2,C3P3,C3P4,C3P5,C3P6,C3P7,C3P8,C3P9,C3P10,C3P11,C3P12,1,1,1))

            data_table.add_hline()
            data_table.add_row((bold("CO4"),C4P1,C4P2,C4P3,C4P4,C4P5,C4P6,C4P7,C4P8,C4P9,C4P10,C4P11,C4P12,1,1,1))

            data_table.add_hline()
            data_table.add_row((bold("CO5"),C5P1,C5P2,C5P3,C5P4,C5P5,C5P6,C5P7,C5P8,C5P9,C5P10,C5P11,C5P12,1,1,1))

            data_table.add_hline()
            data_table.add_row((bold("CO6"),C6P1,C6P2,C6P3,C6P4,C6P5,C6P6,C6P7,C6P8,C6P9,C6P10,C6P11,C6P12,1,1,1))
            data_table.add_hline()
